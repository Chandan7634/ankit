...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary float-left">Product Lists</h4>
        ...
        <div class="card-body">
            <div class="table-responsive">
                @if (count($products) > 0)
                    <table class="table align-middle mb-0 table-hover table-centered" id="product-dataTable">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Title</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($products as $product)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge p-2 bg-light text-dark fs-12 me-1">
                                            @if ($product->stock > 0)
                                                {{ $product->stock }}
                                            @else
                                                {{ $product->stock }}
                                    ...
                                    <td>
                                        @if ($product->photo)
                                            ...
                                            <div
                                                ...
                                                <img src="{{ Storage::url($photo[0]) }}" alt="" class="avatar-md">
                                            </div>
                                        @else
