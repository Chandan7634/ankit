...
@section('title', 'Fulvari || Brand Page')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                @if (count($brands) > 0)
                    <table class="table align-middle mb-0 table-hover table-centered" id="banner-dataTable" width="100%"
                        cellspacing="0">
                        <thead>
                            <tr>
                                <th>#</th>
...
@push('styles')
    <link href="{{ asset('assets/old//vendor/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
...
@push('scripts')
    <!-- Page level plugins -->
    <script src="{{ asset('assets/old/vendor/datatables/jquery.dataTables.min.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('assets/old/js/demo/datatables-demo.js') }}"></script>
    <script>
