        ...
        <div class="row align-items-center">
            <div class="col-lg-7 mb-md-3 mb-lg-0">
                <div class="row align-items-center">
                    <div class="col flex-horizontal-center">
                        <img class="icon-email" src="{{ asset('frontend/images/icon-email.svg') }}" alt="">
            ...
            <div class="col-lg-5">
                ...
                <form action="{{ route('subscribe') }}" method="post"
                    class="form-subcriber d-flex wow fadeIn animated animated animated" style="visibility: visible;">
                    @csrf
